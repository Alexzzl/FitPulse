# FitPulse TV 的 Seller Office 字段填写模板
...
- 这份模板是按 FitPulse TV 当前页面和功能整理的可直接复制稿。
...
| 字段 | 建议值 | 备注 |
|---|---|---|
| Application Name | `FitPulse TV` | Seller Office 内部管理名 |
...
| 字段 | 建议值 | 备注 |
|---|---|---|
| Package File | `你的已签名 FitPulse TV .wgt` | 上传最新签名包 |
...
- 生成后的 `FitPulse TV` UI Description `PPTX`
